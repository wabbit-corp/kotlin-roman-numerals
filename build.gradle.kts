...
kover {
    ...
    //             // title.set("kotlin-roman-numerals Code Coverage") // Uncomment to customize title
    //         }
    //         xml {
...
dokka {
    ...
    dokkaSourceSets.main {
        ...
        sourceLink {
            ...
            remoteUrl("https://github.com/wabbit-corp/kotlin-roman-numerals/tree/master/src/main/kotlin")
