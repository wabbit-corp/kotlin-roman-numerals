...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-roman-numerals", "1.2.0")
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-roman-numerals")
        description.set("kotlin-roman-numerals")
        url.set("https://github.com/wabbit-corp/kotlin-roman-numerals")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/kotlin-roman-numerals")
            connection.set("scm:git:git://github.com/wabbit-corp/kotlin-roman-numerals.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/kotlin-roman-numerals.git")
        }
    }
}
...
dokka {
    moduleName.set("kotlin-roman-numerals")
    ...
    dokkaSourceSets.configureEach {
        ...
        sourceLink {
            ...
            remoteUrl("https://github.com/wabbit-corp/kotlin-roman-numerals/tree/master/src")
